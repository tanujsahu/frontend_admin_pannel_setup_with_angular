...
export class LoginComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private localStorageDataService: localStorageDataService, private router: Router, private messageService: MessageService) { }
